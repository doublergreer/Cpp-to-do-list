#include <iostream>
#include "/Users/ryan/Documents/personalProjects/Cpp-to-do-list/element.h"
using namespace std;
...
int main() {
    ...
    e->writeData("/Users/ryan/Documents/personalProjects/Cpp-to-do-list/listData.txt", "Ryan");
}